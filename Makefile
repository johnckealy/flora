...
test: build-python
	$(IN_ENV) && export DJANG_SETTINGS_MODULE=api.config.settings && export SQL_ENGINE=django.db.backends.sqlite3 && export SQL_DATABASE=:memory: && $(PYTHON) -m pytest api/tests/
