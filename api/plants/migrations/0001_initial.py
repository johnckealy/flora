# Generated by Django 3.1.5 on 2021-01-30 20:42
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('warning_lower', models.DecimalField(decimal_places=1, max_digits=4, null=True)),
                ('warning_upper', models.DecimalField(decimal_places=1, max_digits=4, null=True)),
                ('alert_lower', models.DecimalField(decimal_places=1, max_digits=4, null=True)),
                ('alert_upper', models.DecimalField(decimal_places=1, max_digits=4, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='ReadingHistory',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('scientific_name', models.CharField(max_length=70, null=True)),
                ('plant_name', models.CharField(max_length=70)),
